...
class ConnectController(Controller):
    def __init__(
        ...
        super().__init__()
        self.parameter: Dict[str, dict] = parameter
    ...
    def start_controller(self, fl_ctx: FLContext):
        self.fl_ctx = fl_ctx
        self.clients = fl_ctx.get_engine().get_clients()
    ...
    def control_flow(self, abort_signal: Signal, fl_ctx: FLContext):
        ...
        if not ConnectController._wait_for_all_results(
                ...
                for ds in self.client_statistics[statistic][client]:
                    ...
                    for feature_name in self.client_statistics[statistic][client][ds]:
                        ...
                        if statistic == StC.STATS_HISTOGRAM:
                            ...
                            buckets = ConnectController._apply_histogram_precision(hist.bins, self.precision)
    ...
    def _prepare_inputs(self, statistic_task: str) -> Shareable:
        inputs = Shareable()
        target_statistics: List[StatisticConfig] = ConnectController._get_target_statistics(
